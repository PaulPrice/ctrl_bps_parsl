...
# ParamSpecKwargs requires python>=3.10
try:
    from typing import ParamSpecKwargs  # type: ignore
except ImportError:
    from typing import Dict, Any
    ParamSpecKwargs = Dict[str, Any]
...
class Slurm(SiteConfig):
    ...
    def make_executor(
        ...
        *,
        ...
        provider_options: Optional[ParamSpecKwargs] = None,
        executor_options: Optional[ParamSpecKwargs] = None,
    ) -> ParslExecutor:
...
class TripleSlurm(Slurm):
    ...
    def get_executors(
        self,
        small_options: Optional[ParamSpecKwargs] = None,
        medium_options: Optional[ParamSpecKwargs] = None,
        large_options: Optional[ParamSpecKwargs] = None,
        **common_options,
    ) -> List[ParslExecutor]:
        """Get a list of executors to be used in processing
